    ...
    var e, t, n, r, o = document.getElementById("kt_table_users"),
        ...
        l = () => {
            ...
            c.forEach((e => { 
                ...
                Swal.fire({
                    text: "Secili Anketleri Silmek Istediginize Eminmisiniz?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    ...
                    var options = {};
                    options.url = "/SurveyAssigned/DeleteList";
                    options.type = "POST";
                    ...
                    t.value ? Swal.fire({
                        ...
                        text: "Secili Anketler Silinemedi",
                        icon: "error",
                        buttonsStyling: !1,
                        confirmButtonText: "Tamam!",
                        customClass: {
